    ...
    <div ref={containerRef} className="relative h-[500vh] bg-[#050505]">
      ...
      <div className="absolute inset-0 pointer-events-none px-6 md:px-0">
        ...
        <Section progress={scrollYProgress} range={[0, 0.2]}>
          <motion.div className="text-center w-full max-w-[100vw] px-4">
            <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tighter text-white leading-tight">
              Zenith X
            </h1>
        ...
        <Section progress={scrollYProgress} range={[0.25, 0.45]} align="left">
          <div className="w-full max-w-xs sm:max-w-md md:max-w-xl mb-[25vh] md:mb-0">
            <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1]">
        ...
        <Section progress={scrollYProgress} range={[0.55, 0.75]} align="right">
          <div className="w-full max-w-xs sm:max-w-md md:max-w-xl text-right mt-[25vh] md:mt-0">
            <h2 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-[1.1]">
              Internal <br />Mastery.
            </h2>
            <p className="text-sm sm:text-base md:text-xl text-white/50 mt-4 md:mt-10 leading-relaxed font-light">
        ...
        <Section progress={scrollYProgress} range={[0.85, 1]}>
          <div className="text-center w-full max-w-[100vw] px-4">
            <h2 className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight text-white mb-8 md:mb-16 leading-tight">
